#line 1 "/home/archaoss/Arduino/rbr_magnac/WiFiMagnac.h"
// eprivat 2024-08-14
...
{
  const char* ssid PROGMEM = "Livebox-4520";
  const char* pass PROGMEM = "eTJEjoyTs5d4ngpoku";
  const char* host PROGMEM = "esp32-magnac";
